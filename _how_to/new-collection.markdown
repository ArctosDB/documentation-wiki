...
That representative should create a project in the [new-collections Github repository](https://github.com/ArctosDB/new-collections) using the steps outlined in both this document and the Issue [templates available in the new-collections Github repository](https://github.com/ArctosDB/new-collections/issues/new/choose).
