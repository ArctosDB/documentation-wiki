...
{% include tip.html content="If this is confusing, please read the [Identification Order Documentation]({{ site.baseurl }}/documentation/identification#identification-order)" %}
