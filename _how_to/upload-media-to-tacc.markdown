...
{% include tip.html content="Read [Best Practice - Managing Directory Structures in the Arctos Project Allocation at TACC]({{ '/best_practices/tacc-allocation' | relative_url }}) %}
