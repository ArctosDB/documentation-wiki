...
{% include tip.html content="Read [Best Practice - Managing Directory Structures in the Arctos Project Allocation at TACC]({% link _best_practices/tacc-allocation.markdown %}) %}
