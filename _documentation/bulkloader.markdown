...
|<span class="blcondreq">LatDeg<sup>2 and 3</sup></span> | positive number| Degrees Latitude (Integer, 90 or less). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_) and [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
...
|<span class="blcondreq">LatDir<sup>2 and 3</sup></span> | text; N or S | Latitude Direction: "N" or "S" (North or South). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_) and [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">LongDeg<sup>2 and 3</sup></span> | positive number | Degrees Longitude (Integer, 180 or less). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_) and [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
...
|<span class="blcondreq">LongDir<sup>2 and 3</sup></span> | text; W or E | Longitude Direction: "E" or "W" (East or West). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_) and [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Lat_Min<sup>3</sup></span> |  positive number | Decimal Latitude Minutes (Used with LatDeg, decimal fraction, less than 60). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
