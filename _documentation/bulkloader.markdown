...
|<span class="blrequired">GEOREFERENCE_PROTOCOL</span> | text;[ ctgeoreference_protocol](http://arctos.database.museum/info/ctDocumentation.cfm?table=ctgeoreference_protocol) ||
...
|<span class="blcondreq">Dec_Lat<sup>1</sup></span> | number | Decimal latitude. Use with Orig_Lat_Long_Units [decimal degrees](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#decimal_degrees). | 
|<span class="blcondreq">Dec_Long<sup>1</sup></span> | number | Decimal longitude. Use with Orig_Lat_Long_Units [decimal degrees](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#decimal_degrees). | 
|<span class="blcondreq">LatDeg<sup>2 and 3</sup></span> | positive number| Degrees Latitude (Integer, 90 or less). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LatMin<sup>2</sup></span> | positive number | Minutes Latitude (Integer, less than 60). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LatSec<sup>2</sup></span> | positive number | Seconds Latitude (Decimal fraction, less than 60). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LatDir<sup>2 and 3</sup></span> | text; N or S | Latitude Direction: "N" or "S" (North or South). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LongDeg<sup>2 and 3</sup></span> | positive number | Degrees Longitude (Integer, 180 or less). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LongMin<sup>2</sup></span> | positive number | Minutes Longitude (Integer, less than 60). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LongSec<sup>2</sup></span> | positive number | Seconds Longitude (Decimal fraction, less than 60). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">LongDir<sup>2 and 3</sup></span> | text; W or E | Longitude Direction: "E" or "W" (East or West). Use with Orig_Lat_Long_Units [deg. min. sec.](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#deg__min__sec_). |
|<span class="blcondreq">Dec_Lat_Deg<sup>3</sup></span> |  positive number | Decimal Latitude Degrees (Integer, less than 60). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Lat_Min<sup>3</sup></span> |  positive number | Decimal Latitude Minutes (Decimal fraction, less than 60). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Lat_Dir<sup>3</sup></span> |  text; N or S | Latitude Direction: "N" or "S" (North or South). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Long_Deg<sup>3</sup></span> |  positive number | Decimal Longitude Degrees (Integer, less than 60). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Long_Min<sup>3</sup></span> | positive number| Decimal Longitude Minutes (Used with LongDeg, decimal fraction, less than 60). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
|<span class="blcondreq">Dec_Long_Dir<sup>3</sup></span> |  text; N or S | Longitude Direction: "N" or "S" (North or South). Use with Orig_Lat_Long_Units [degrees dec. minutes](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctlat_long_units#degrees_dec__minutes). |
...
|<span class="bloptional">cataloged_item_type</span> | text: [ctcataloged_item_type](https://arctos.database.museum/info/ctDocumentation.cfm?table=ctcataloged_item_type) | Designates the type of material held, passed to biodiversity data aggregators as BasisOfRecord. A value here will over-ride anything entered into Default Cataloged Item Type in Manage Collection. |
