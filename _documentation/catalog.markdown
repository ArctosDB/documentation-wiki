...
* [https://arctos.database.museum/guid/DMNS:Mamm:12344](https://arctos.database.museum/guid/DMNS:Mamm:12344) and https://arctos.database.museum/guid/MSB:Mamm:233616 together represent one Occurrence, with parts in different collections. These are provided to DWC as two Occurrences; we make no attempt to merge them.
* [https://arctos.database.museum/guid/MVZ:Egg:10460](https://arctos.database.museum/guid/MVZ:Egg:10460) represents two Occurrences (the thrush and the cuckoo). We provide this to DWC as a single Occurrence.
* [https://arctos.database.museum/guid/MSB:Mamm:193703](https://arctos.database.museum/guid/MSB:Mamm:193703) represents two Occurrences, and is provided via DWC as two Occurrences. In this case a single individual was sampled multiple times, and the samples were cataloged as one record.
