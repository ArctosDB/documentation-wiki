...
collection (duplicate catalog numbers within a collection are not allowed). Varoius formats are supported and bring various functional limitations with them.
