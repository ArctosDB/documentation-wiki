...
The catalog record API may be made available to qualified researchers. To request an API key, file an [Issue](https://github.com/ArctosDB/arctos/issues). Please include:
...
A cache of the data which powers (most) of the API may also be made available; file an Issue as above.
