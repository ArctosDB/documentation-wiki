...
encumbrances.) Do **not** just copy-paste the encumbrance action here.
Really. Don’t.
...
1.  Find the specimens from which you wish to remove an
    encumbrance using SpecimenSearch.
...
3.  Find the appropriate encumbrance by entering search criteria and
    clicking Find Encumbrance. Under the appropriate encumbrance, click the "Remove Listed Items
