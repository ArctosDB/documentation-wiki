...
* Follow standard file naming practices in [Arctos Media: Media URI Documentation]({% link _documentation/media.markdown %}#media-uri). Specifically, name files using ony A-Z, a-z, 0-9, and _ 
